...
int get_random_index_for_bin(int max_length) {
	int index = rand() % max_length;
	return index;
}

void print_string_for_bin(char* string, int chunk_size) {
...
void binnumbers_game(int amount_of_numbers, int length_of_time) {
		char character_pool[] = "01";
